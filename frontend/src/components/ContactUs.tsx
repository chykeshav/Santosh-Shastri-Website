      ...
      <div className="max-w-[1400px] w-[95%] w-full">
        ...
        <div className="bg-[#0f0f0f] text-white rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-10 md:p-14 relative overflow-hidden">
            ...
            <h1 className="text-4xl font-bold mb-8 font-serif" style={{ color: '#D4AF37' }}>
              Contact us
            </h1>
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 flex-shrink-0 bg-pink-500 rounded-full flex items-center justify-center shadow-lg shadow-pink-500/30">
              ...
              {/* Phone/WhatsApp */}
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 flex-shrink-0 bg-amber-500 rounded-full flex items-center justify-center shadow-lg shadow-amber-500/30">
              ...
              {/* Email */}
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 flex-shrink-0 bg-blue-500 rounded-full flex items-center justify-center shadow-lg shadow-blue-500/30">
                ...
                <div>
                  ...
                  <a href="mailto:soumyamarriagebureau@gmail.com" className="text-gray-400 hover:text-blue-400 transition block">
          ...
          <div className="w-full md:w-1/2 bg-gray-900 relative min-h-[300px]">
            <img src="https://loremflickr.com/600/800/mumbai,city?random=20" alt="Mumbai City" className="w-full h-full object-cover opacity-50" />
